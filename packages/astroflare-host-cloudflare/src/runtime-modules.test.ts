...
// @ts-expect-error
import RUNTIME_COMPONENTS_SRC from "../../astroflare-runtime/dist/components.js?raw";
// @ts-expect-error
import RUNTIME_COOKIES_SRC from "../../astroflare-runtime/dist/cookies.js?raw";
// @ts-expect-error
import RUNTIME_ENV_SRC from "../../astroflare-runtime/dist/env.js?raw";
// @ts-expect-error
import RUNTIME_ERROR_OVERLAY_SRC from "../../astroflare-runtime/dist/error-overlay.js?raw";
// @ts-expect-error
import RUNTIME_HMR_SRC from "../../astroflare-runtime/dist/hmr-client.js?raw";
// @ts-expect-error
import RUNTIME_HYDRATION_SRC from "../../astroflare-runtime/dist/hydration-client.js?raw";
// @ts-expect-error
import RUNTIME_I18N_SRC from "../../astroflare-runtime/dist/i18n.js?raw";
// @ts-expect-error
import RUNTIME_INDEX_SRC from "../../astroflare-runtime/dist/index.js?raw";
// @ts-expect-error
import RUNTIME_INTERNAL_SRC from "../../astroflare-runtime/dist/internal.js?raw";
// @ts-expect-error
import RUNTIME_JSX_RUNTIME_SRC from "../../astroflare-runtime/dist/jsx-runtime.js?raw";
// @ts-expect-error
import RUNTIME_PREFETCH_SRC from "../../astroflare-runtime/dist/prefetch-client.js?raw";
// @ts-expect-error
import RUNTIME_REACT_ADAPTER_SRC from "../../astroflare-runtime/dist/react-adapter.js?raw";
// @ts-expect-error
import RUNTIME_REACT_SSR_SRC from "../../astroflare-runtime/dist/react-ssr.js?raw";
// @ts-expect-error
import RUNTIME_RENDER_SRC from "../../astroflare-runtime/dist/render.js?raw";
// @ts-expect-error
import RUNTIME_RSS_SRC from "../../astroflare-runtime/dist/rss.js?raw";
// @ts-expect-error
import RUNTIME_SITEMAP_SRC from "../../astroflare-runtime/dist/sitemap.js?raw";
// @ts-expect-error
import RUNTIME_VT_SRC from "../../astroflare-runtime/dist/view-transitions-client.js?raw";
